-- Fix the admin_create_invoice function to ensure it properly generates invoice numbers
-- This recreates the function with proper error handling and debugging
